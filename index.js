    ...
    <div class="espaciotabladearriba"> 
        <table class="tablacompleta" style="width: 100%; ">
            ...
            <tr style="width: 100%;">
                ...
                <td style="text-align: center; line-height: 10px; background-color: #FFFFFF; border-color: #A6A6A6; width: 37%; font-size: 11px; text-align: justify; padding-top: 10px; padding-bottom: 10px; " ></td>
                ...
                <td colspan="5" style="text-align: center; line-height: 10px; background-color: #FFFFFF; border-color: #A6A6A6; width: 41%; font-size: 11px; text-align: justify; padding-top: 10px; padding-bottom: 10px;" ></td>
            </tr>
            ...
            <tr style="width: 100%;">
              ...
              <td style="text-align: center; line-height: 10px; background-color: #FFFFFF; border-color: #A6A6A6; width: 37%;  font-size: 11px; text-align: justify;" ></td>
              ...
              <label  class="margendospxsize" ><input type="radio" style=" margin-right: 4px; "  name="estado"></label>Si
              </td>
              <td style="text-align: center; line-height: 10px; background-color: #FFFFFF; border-color: #A6A6A6; width: %7; font-size: 11px; text-align: justify; " >
              <label class="margendospxsize"><input type="radio" style=" margin-right: 4px; font-size: 14px;" name="estado"></label>No
              </td>
              ...
              <td style="text-align: center; line-height: 10px; background-color: #FFFFFF; border-color: #A6A6A6; width: %7; font-size: 11px; text-align: justify; " >
              <label class="margendospxsize"><input type="radio" style=" margin-right: 4px; font-size: 14px;" name="estado"></label>Si
              </td>
...
<table class="espaciotabladearriba">
    ...
    <tbody id="tabla-body" class="bodytablahojauno">
      ...
      <tr class="diseñocolumnahojados" >    <!-- Fila13 -->
        ...
        <div style="display: -webkit-box; display: -ms-flexbox; display: flex; width: 100%">
          ...
          <label class="margendospxsize"><input type="radio" style=" margin-right: 4px;" name="estado"></label>No
          </div>
        </div>
        </td>
        <td class="titulosseccionII"> </td>
    ...
    <tbody id="tabla-body" class="bodytablahojauno">
      ...
      <tr class="diseñocolumnahojados" >    <!-- Fila7 -->
        ...
        <div style="display: -webkit-box; display: -ms-flexbox; display: flex; width: 100%">
          ...
          <label class="margendospxsize"><input type="radio" style=" margin-right: 0px;" name="estado"></label>Si
          </div>
          <div style="width: 33%; border-right: 1px solid #A6A6A6; padding-top: 6px; padding-bottom: 6px;">
          <label class="margendospxsize"><input type="radio" style=" margin-right: 0px; " name="estado"></label>No
          </div>
          <div style="width: 34%; padding-top: 6px;">
          <label class="margendospxsize"><input type="radio" style=" margin-right: 0px;  " name="estado"></label>N/A*
          </div>
        </div>
        </td>
        <td class="titulosseccionII"> </td>
  ...
  <div>
  <p style=" font-size: 10px; ">*NA = No aplica</p>
</div>
