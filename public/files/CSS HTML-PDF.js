...
const generarPDF = () => {
  ...
  <body >
    ...
    <div class="container">
        ...
        <p class="tituloysub" style="  padding-top: 0px; padding-bottom: 3px; line-height: 11px;" >Formato registro de las acciones implementadas de Detección y Reparación de Fugas por equipo o Componente.
        </div>
    ...
    <div class="espaciotabladearriba"> 
        <table class="tablacompleta" style="width: 100%; ">
            <tr>
                <td colspan="8" style="font-size: 9px; text-align: center; line-height: 3px; background-color: #D9D9D9; border-color: #A6A6A6;">Sección I. Datos generales</td>
            </tr>
            <tr style="width: 100%;">
                <td style="text-align: center; line-height: 7px; background-color: #FFFFFF; border-color: #A6A6A6; width: 11%; font-size: 7px; text-align: justify; " >Nombre de la Instalación</td>
                <td style="text-align: center; line-height: 7px; background-color: #FFFFFF; border-color: #A6A6A6; width: 37%; font-size: 7px; text-align: justify;  " ></td>
                <td style="text-align: center; line-height: 7px; background-color: #FFFFFF; border-color: #A6A6A6; width: 11%;  font-size: 7px; text-align: justify; " >Ubicación de la instalación</td>
                <td colspan="5" style="text-align: center; line-height: 7px; background-color: #FFFFFF; border-color: #A6A6A6; width: 41%; font-size: 7px; text-align: justify; " ></td>
            </tr>
            
            <tr style="width: 100%;">
              <td style="text-align: center; line-height: 7px; background-color: #FFFFFF; border-color: #A6A6A6; width: 11%;  font-size: 7px; text-align: justify;" >Id y tipo de equipo a Componente</td>
              <td style="text-align: center; line-height: 7px; background-color: #FFFFFF; border-color: #A6A6A6; width: 37%;  font-size: 7px; text-align: justify;" ></td>
              <td style="text-align: center; line-height: 7px; background-color: #FFFFFF; border-color: #A6A6A6; width: 11%;  font-size: 7px; text-align: justify;" >Equipo critico</td>
              <td style="text-align: center; line-height: 7px; background-color: #FFFFFF; border-color: #A6A6A6; width: %7;  font-size: 7px; text-align: justify; " >
              ...
              <td style="text-align: center; line-height: 7px; background-color: #FFFFFF; border-color: #A6A6A6; width: 10%; font-size: 7px; text-align: justify;" >Inspección tecnica del riesgo</td>
              <td style="text-align: center; line-height: 7px; background-color: #FFFFFF; border-color: #A6A6A6; width: %7; font-size: 7px; text-align: justify; " >
              <label class="margendospxsize"><input type="radio" style=" margin-right: 4px;" name="estado">Si</label>
              </td>
              <td style="text-align: center; line-height: 7px; background-color: #FFFFFF; border-color: #A6A6A6; width: 8%; font-size: 7px; text-align: justify; " >
              <label class="margendospxsize"><input type="radio" style=" margin-right: 4px;" name="estado">No</label>
              </td>
            </tr>
        </table>
...
<table class="espaciotabladearriba">
    <thead >
      ...
      <tr style="font-size: 8px; text-align: center; line-height: 4px;">
        ...
        <td class="trestitulosSeccionII" style="width: 11%; line-height: 9px;">Inspección técnica 1</td>
        <td class="trestitulosSeccionII" style="width: 11%; line-height: 9px;">Inspección técnica 2</td>
        <td class="trestitulosSeccionII" style="width: 11%; line-height: 9px;">Inspección técnica 3</td>
        <td class="trestitulosSeccionII" style="width: 11%; line-height: 9px;">Inspección técnica 4</td>
        <td class="trestitulosSeccionII" style="width: 11%; line-height: 9px;">Inspección técnica 5</td>
      </tr>
    </thead>
    <tbody id="tabla-body" class="bodytablahojauno">
      ...
      <tr class="diseñocolumnahojados" >    <!-- Fila6 -->
        <td class="titulosseccionII" >Factores técnicos y ambientales durante la inspección técnica</td>
        <td class="titulosseccionII"> </td>
        <td class="titulosseccionII"> </td>
        <td class="titulosseccionII"> </td>
        <td class="titulosseccionII"> </td>
  ...
  <table class="espaciotabladearriba tablacompleta">
    ...
    <tbody id="tabla-body" class="bodytablahojauno">
      ...
      <tr class="diseñocolumnahojados" >    <!-- Fila5 -->
        <td class="titulosseccionII">Hora de comprobación de la reparación (hh:mm)</td>
        <td class="titulosseccionII"> </td>
        <td class="titulosseccionII"> </td>
        <td class="titulosseccionII"> </td>
        <td class="titulosseccionII"> </td>
      ...
      <tr class="diseñocolumnahojados" >    <!-- Fila7 -->
        ...
        <div style="display: -webkit-box; display: -ms-flexbox; display: flex; width: 100%">
          ...
          <label class="margendospxsize"><input type="radio" style=" margin-right: 4px; " name="estado">N/A*</label>
          </div>
        </div>
        </td>
        <td class="titulosseccionII"> </td>
  ...
  <div>
    <p style=" font-size: 7px; ">*NA = No aplica</p>
  </div>
      ...
      <tr style="filasseccionIV" >
        ...
        <p class="text-align: start;  padding: 0px; margin: 0px; line-height: 0px; left: 2%;"> <strong><span style=" color: transparent;">---</span>Indicaciones generales</strong><p>
          <ol type="a" style="font-size: 9px;"> 
            ...
            <li class="interlineadodiezpx">Se deberá llenar un formato por equipo o Componente dentro del programa de Detección y Reparación por Fuga.
            <li class="interlineadodiezpx">Se deberá llenar una columna por cada inspección técnica.
          </ol>
